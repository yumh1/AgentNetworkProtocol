# 从OpenAI的Operator，看AI与互联网交互的三种技术路线
...
本文主要是对比、总结当前已经出现的AI与互联网交互的三种技术路线。本文核心观点如下：

- 当前已经出现的AI与互联网交互的技术路线包括：Computer Use Agent，Headless Browser（无头浏览器），API/Protocol。
...
- API/Protocol：这是AI访问互联网最擅长的方式，能够异步执行任务，运行成本低，并且支持自动身份认证。但是需要应用配合升级，接入成本高。
...
ANP的全称是Agent Network Protocol，https://github.com/chgaowei/AgentNetworkProtocol，是行业首个面向智能体设计的开源通信协议。ANP与MCP的区别是，ANP以智能体为中心，每个智能体都具有同等地位，目标构建一个高效的智能体协作网络。
...
我们正在开发一个用于智能体通信的开源标准协议：**AgentNetworkProtocol(ANP)**，项目地址：[https://github.com/chgaowei/AgentNetworkProtocol](https://github.com/chgaowei/AgentNetworkProtocol)。
